...
Generated on: 2025-09-30 15:40:11
Calculation Type: Geometry Optimization
Model: SevenNet-0 (Latest Universal)
Device: cuda
Precision: float32
...
def main():
    ...
    print(f"🤖 Model: SevenNet-0 (Latest Universal)")
    print(f"💻 Device: cuda")
    ...
    try:
        ...
        print(f"🎯 Selected model: SevenNet-0 (Latest Universal)")
        print(f"🎯 Model function: 7net-0")

        # Parse model and modal from the model_size
        if "7net-0" == "7net-mf-ompa-mpa":
        ...
        elif "7net-0" == "7net-mf-ompa-omat24":
            ...
            print(f"✅ SevenNet 7net-0 initialized successfully on {device}")
    ...
    structure_files = [f for f in os.listdir(".") if f.startswith("POSCAR") or f.endswith(".vasp")]
    results = []
